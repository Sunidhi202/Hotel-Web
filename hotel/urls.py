...
urlpatterns = [
    ...
    path('user/book-room/<int:roomid>/<str:cin>/<str:cout>', views.book_room_page,name="bookroompage"),
    ...
    path('staff/panel/edit-item/<int:id>', views.edit_item),
